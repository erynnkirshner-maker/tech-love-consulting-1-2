    ...
    <>
      ...
      <section className="section-spacing">
        <div className="container content-narrow">
          ...
          <p className="text-lg text-foreground/70 mb-8">60 minutes. One highest-leverage opportunity. A clear next step.</p>
      ...
      <section className="section-spacing bg-sand">
        <div className="container content-narrow text-center">
          ...
          <p className="font-serif text-2xl font-bold text-teal">Starting at $750.</p>
        </div>
      </section>
