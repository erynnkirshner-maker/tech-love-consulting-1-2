    ...
    <>
      ...
      <section className="section-spacing">
        <div className="container content-narrow">
          ...
          <h2 className="text-xl mb-4">Who we are</h2>
          <p>
          ...
          <h2 className="text-xl mb-4">What we collect</h2>
          ...
          <h2 className="text-xl mb-4">Who we share it with</h2>
          <p>
          ...
          <h2 className="text-xl mb-4">Changes to this policy</h2>
          <p>
